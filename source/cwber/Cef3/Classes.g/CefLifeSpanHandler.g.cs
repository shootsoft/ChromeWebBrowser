...
namespace Cef3
{
    ...
    public abstract unsafe partial class CefLifeSpanHandler
    {
        ...
        private cef_life_span_handler_t.get_refct_delegate _ds2;
        ...
        protected CefLifeSpanHandler()
        {
            ...
            _ds2 = new cef_life_span_handler_t.get_refct_delegate(get_refct);
        ...
        private int add_ref(cef_life_span_handler_t* self)
        {
            lock (SyncRoot)
            {
                var result = ++_refct;
        ...
        private int get_refct(cef_life_span_handler_t* self)
        {
            return _refct;
        }
