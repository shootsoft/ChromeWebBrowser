...
namespace Cef3
{
    ...
    public abstract unsafe partial class CefDomVisitor
    {
        ...
        private cef_domvisitor_t.get_refct_delegate _ds2;
        ...
        protected CefDomVisitor()
        {
            ...
            _ds2 = new cef_domvisitor_t.get_refct_delegate(get_refct);
        ...
        private int add_ref(cef_domvisitor_t* self)
        {
            lock (SyncRoot)
            {
                var result = ++_refct;
        ...
        private int get_refct(cef_domvisitor_t* self)
        {
            return _refct;
        }
