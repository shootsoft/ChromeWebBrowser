...
namespace Cef3
{
    ...
    public abstract unsafe partial class CefStringVisitor
    {
        ...
        private cef_string_visitor_t.get_refct_delegate _ds2;
        ...
        protected CefStringVisitor()
        {
            ...
            _ds2 = new cef_string_visitor_t.get_refct_delegate(get_refct);
        ...
        private int add_ref(cef_string_visitor_t* self)
        {
            lock (SyncRoot)
            {
                var result = ++_refct;
