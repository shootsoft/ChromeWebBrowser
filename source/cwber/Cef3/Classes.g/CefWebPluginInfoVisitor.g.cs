...
namespace Cef3
{
    ...
    public abstract unsafe partial class CefWebPluginInfoVisitor
    {
        ...
        private cef_web_plugin_info_visitor_t.get_refct_delegate _ds2;
        ...
        protected CefWebPluginInfoVisitor()
        {
            ...
            _ds2 = new cef_web_plugin_info_visitor_t.get_refct_delegate(get_refct);
        ...
        private int add_ref(cef_web_plugin_info_visitor_t* self)
        {
            lock (SyncRoot)
            {
                var result = ++_refct;
