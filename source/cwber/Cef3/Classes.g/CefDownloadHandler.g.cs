...
namespace Cef3
{
    ...
    public abstract unsafe partial class CefDownloadHandler
    {
        ...
        private cef_download_handler_t.get_refct_delegate _ds2;
        ...
        protected CefDownloadHandler()
        {
            ...
            _ds2 = new cef_download_handler_t.get_refct_delegate(get_refct);
        ...
        private int add_ref(cef_download_handler_t* self)
        {
            lock (SyncRoot)
            {
                var result = ++_refct;
        ...
        private int get_refct(cef_download_handler_t* self)
        {
            return _refct;
        }
